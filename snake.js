...
// скорость движения змеи. каждый кадр перемещает сетку на одну длину в 
// направлении x или y
dx: grid,
dy: 0,
...
// рисунок на 1 пиксель меньше сетки создает эффект сетки в теле змеи, чтобы 
// вы могли видеть, какой она длины
...
// проверьте соответствие со всеми ячейками после этой (измененная 
...
canvasScore.textContent="Score: " + snake.cells.length
}
